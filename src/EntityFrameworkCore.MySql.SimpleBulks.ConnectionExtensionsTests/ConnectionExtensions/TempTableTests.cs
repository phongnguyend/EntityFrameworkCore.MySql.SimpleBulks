 ...
 CountryIsoCode = "US"
   ...
   CountryIsoCode = "VI"
    ...
    public void Non_Entity_Type_Single_Table_With_Selected_Columns()
    {
        ...
        var tableName = connectionContext.CreateTempTable(_customers,
       x => new
       {
           x.IdNumber,
           x.FirstName,
    ...
    public void Non_Entity_Type_Multiple_Tables_With_Selected_Columns()
    {
        ...
        var customerTableName = connectionContext.CreateTempTable(_customers,
            x => new
            {
                x.IdNumber,
                x.FirstName,
...
.ThenBy(x => x.PhoneNumber)
    ...
    public void Entity_Type_Multiple_Tables()
    {
        ...
        // Act
        var customerTableName = connectionContext.CreateTempTable(customers,
    ...
    public void Entity_Type_Single_Table_With_Mappings()
    {
        ...
        // Act
        var tableName = connectionContext.CreateTempTable(configurationEntries,
               ["Id", "Key", "Value"],
               new TempTableOptions
               {
                   LogTo = LogTo
