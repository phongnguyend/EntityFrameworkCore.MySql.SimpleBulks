...
public class DirectDeleteTests : IDisposable
{
    private readonly ITestOutputHelper _output;

    private TestDbContext _context;

    public DirectDeleteTests(ITestOutputHelper output)
    {
        _output = output;

        _context = new TestDbContext($"server=localhost;database=SimpleBulks.DirectDelete.{Guid.NewGuid()};user=root;password=mysql;AllowLoadLocalInfile=true");
