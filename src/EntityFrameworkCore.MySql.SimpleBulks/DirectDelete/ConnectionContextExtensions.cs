...
{
    public static BulkDeleteResult DirectDelete<T>(this ConnectionContext connectionContext, T data, MySqlTableInfor table = null, BulkDeleteOptions options = null)
    {
