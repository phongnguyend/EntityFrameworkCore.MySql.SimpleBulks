...
namespace EntityFrameworkCore.MySql.SimpleBulks.Tests.IListExtensions;
...
public class ToDataTableTests
{
    ...
    public Task ToDataTable_SingleKeyRow()
    {
        ...
        var script = dataTable.GenerateTempTableDefinition("SingleKeyRows", null, null);
    ...
    public Task ToDataTable_CompositeKeyRow()
    {
        ...
        var script = dataTable.GenerateTempTableDefinition("CompositeKeyRows", null, null);
    ...
    public Task ToDataTable_ColumnMapping()
    {
        ...
        var script = dataTable.GenerateTempTableDefinition("ConfigurationEntries", columnNames, columnTypes);
    ...
    public Task ToDataTable_ComplexType()
    {
        ...
        var script = dataTable.GenerateTempTableDefinition("ComplexTypeOrders", null, null);
    ...
    public Task ToDataTable_OwnedType()
    {
        ...
        var script = dataTable.GenerateTempTableDefinition("OwnedTypeOrders", null, null);
