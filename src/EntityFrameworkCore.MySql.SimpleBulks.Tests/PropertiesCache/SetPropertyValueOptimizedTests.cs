namespace EntityFrameworkCore.MySql.SimpleBulks.Tests.PropertiesCache;

public class SetPropertyValueOptimizedTests
{
    [Fact]
    public void SetPropertyValue_Current_Level()
    {
        ...
        PropertiesCache<Order>.SetPropertyValueOptimized("Id", order, 1);
    ...
    public void SetPropertyValue_One_Level()
    {
        ...
        PropertiesCache<Order>.SetPropertyValueOptimized("ShippingAddress.Street", order, "xxx");
    ...
    public void SetPropertyValue_Two_Levels()
    {
        ...
        PropertiesCache<Order>.SetPropertyValueOptimized("ShippingAddress.Location.Lat", order, 40.7128);
