...
public class BulkInsertTests : BaseTest
{
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkInsert_Using_Linq_Without_Transaction(int length)
    {
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkInsert_Using_Linq_With_Transaction_Committed(int length)
    {
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkInsert_Using_Linq_With_Transaction_RolledBack(int length)
    {
        var tran = _context.Database.BeginTransaction();
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkInsert_Using_DynamicString(int length)
    {
        var rows = new List<SingleKeyRow<int>>();
        var compositeKeyRows = new List<CompositeKeyRow<int, int>>();
