...
public class BulkUpdateTests : BaseTest
{
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkUpdate_PrimaryKeys(int length)
    {
        SeedData(length);
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkUpdate_PrimaryKeys_DynamicString(int length)
    {
        SeedData(length);
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkUpdate_SpecifiedKeys(int length)
    {
        SeedData(length);
    ...
    [InlineData(1)]
    [InlineData(100)]
    public void BulkUpdate_SpecifiedKeys_DynamicString(int length)
    {
        SeedData(length);
